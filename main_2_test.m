...
% 
% Note : 
% -> This file checks the weights (theta) calculated by "main_2_train.m"...
...
%%%%%%%%%%%%%%
mach= 50; % number of characteristic lines (no. of points in a nozzle)
...
X = (X - mu)./sigma; % mean normalization 
